...
- **H-06** — política de excedentes de pago de clientes (el Caso #1 de los 10
  rechazos espera exactamente esto).
- **H-07** — cuenta para depósitos recibidos en garantía (caso Formax).
- **H-04** — tablas de amortización de los préstamos vivos (ROADMAP 2b.4).
