...
const PROPUESTA_SCHEMA = (description: string): Dic => ({
  ...
  properties: {
    ...
    lineas: { type: 'array', description: 'items {descripcion,cantidad,precio,descuento?,itbis,cuenta,cuenta_nombre} o partida doble {cuenta,cuenta_nombre,descripcion,debito,credito}. descuento = % 0-99.99 del papel y el precio va BRUTO, nunca el neto aplastado. BillPayments va sin ellas', items: { type: 'object', additionalProperties: true } },
