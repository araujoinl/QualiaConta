...
**Fecha:** 2026-08-05
**Documento ADM:** CB00000228 (BankCharges, UUID b5266e0b-474e-4810-40f1-08def10be22c)
**Aprobó:** C.Araujo, por la mesa web

## Hecho

Cargo del Banco Santa Cruz sobre la cuenta 11122010023874 (Banco Operaciones
874) por RD$300.00, concepto «COMISION POR TRANSFERENCIA LBTR», con NCF
E310004477187 del 2026-08-03. Ampara 3 movimientos del banco (3 comisiones LBTR
del mismo día), agrupados en un solo cargo bancario en ADM.

## Asiento

- Débito 640.01 (Cargos Bancarios) — RD$300.00
- Crédito 101.06 (Banco Operaciones 874) — RD$300.00
...
`Reference` en ADM = `E310004477187` (NCF del cargo), que persistió en el
